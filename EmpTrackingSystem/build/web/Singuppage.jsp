<%-- 
    Document   : Singuppage
    Created on : 7 Apr, 2024, 4:03:02 PM
    Author     : Shubham
--%>
...
<html>
    <head>
        ...
        <title>Admin Sing Up Page</title>
        <style>
        ...
        <h3 class="login-title">Admin Login</h3>
          ...
          <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="Number" class="form-control" name="txt_num" id="floatingInput" required/>
            </div>
          <div class="input-group">
          ...
          <div class="input-group">
            ...
            <button type="submit" class="login-button" name="btn" value="Login">Sign Up</button>
