<%-- 
    Document   : Managerlogin.jsp
    Created on : 11 May, 2023, 11:27:51 PM
    Author     : Shubham
--%>
...
html,
body {
 background-image: url('IMG/how-to-handle-password-security-question-1-1024x678.jpg');
...
.login-button:focus {
  background-color: hsla(201, 100%, 50%, 0.5);
    ...
    <body>
        <form method="post" action="ManLog">
